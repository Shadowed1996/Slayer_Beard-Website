...
### L'icona del lettore di musica

Quando il lettore è ridotto resta un **bottone tondo in basso a destra**, che
lo riapre. Di serie porta il disegno di due note; nella parte **La musica** del
pannello, con **Icona del bottone tondo**, puoi caricarci un'immagine tua —
la mascotte, il logo del canale, quello che vuoi.

L'immagine viene **ritagliata tonda** e riempie tutto il bottone, quindi:
meglio **quadrata** e non troppo piccola (da 96 px in su), in PNG o WebP. Se
