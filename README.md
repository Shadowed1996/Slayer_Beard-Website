...
sono**, **supporto**, **saluti**, **sponsor** (la striscia di chi sostiene il canale). Dal pannello
si possono riordinare e nascondere (la copertina resta sempre prima e accesa); il binario laterale
e il piede ci sono sempre. Il binario ha una voce per ogni sezione accesa, quindi al massimo sei —
