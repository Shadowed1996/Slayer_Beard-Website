/* =====================================================================
   ...
   Generato il 2026-09-06T18:36:18.915Z.
   ===================================================================== */
window.DATI = {
  "twitch": {
    "canale": "slayer_beard",
  ...
  "lurk": {
    ...
    "messaggio": {
      "attivo": true,
      "clientId": "DAxSOSTITUIRExCONxQUELLOxVERO",
      "urlRitorno": "http://localhost:4173/",
      "frasi": [
        "Hey! Lurko dal sito.",
        "Sono in lurk dal sito, buona diretta!",
        "Lurko dal pollaio: ci sono ma sto zitto.",
        "In lurk dal sito. Coccodè."
      ]
    },
    "testi": {
